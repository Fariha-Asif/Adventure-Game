...
console.log(
  chalk.bold.green("/////////////") +
    chalk.bold.italic.blue(
      "Welcome to Fariha's Treasure Hunter Adventures Game..."
    ) +
    chalk.bold.green("/////////////")
);
...
console.log(
  chalk.bold.italic.yellow("You have selected these items:") +
  ...
  if (direction.direction === "NORTH") {
    console.log(
      chalk.bold.italic.yellow(
        "Warning! There are dangerous animals which can harm you."
      )
    );
    ...
    if (side1.side1 === true) {
      ...
      console.log(
        chalk.bold.italic.yellow("You trapped with dangerous animals.")
      );
      condition = false;
      console.log(
        chalk.bold.italic.green(`${name.userName}`) +
    ...
    if (ditch.ditch === "rope") {
      ...
      console.log(
        chalk.bold.italic.yellow(
          "You selected wrong item. you need a rope to come out from ditch."
        )
      );
      condition = false;
      console.log(
    ...
    console.log(
      chalk.bold.italic.yellow(
        "It is almost night, infront of you there is a cave."
      )
    );
    ...
    if (side3.side3 == true) {
      console.log(
        chalk.bold.italic.yellow("In a cave you found a door infront of you.")
      );
      ...
      if (door.door === true) {
        console.log(
          chalk.bold.italic.yellow(
            "You must guess a number between 1-10 for unlock the door."
          )
        );
        console.log(
          chalk.bold.italic.yellow(
            "Remember you have just 3 chance to unlock the door."
          )
        );
        ...
        while (attempts < 3 && !condition2) {
          ...
          if (answer.userGuessedNumber === guess) {
            console.log(
              chalk.bold.italic.yellow("Congratulations!") +
                chalk.bold.italic.green(`${name.userName}`) +
                chalk.bold.italic.yellow(
                  ", You won the game. Here is your treasure."
                )
            );
            condition2 = true;
            ...
            if (again.again === false) {
              ...
              console.log(
                chalk.bold.green("/////////////") +
                  ...
                  chalk.bold.italic.blue(
                    ", Hope you enjoyed Treasure Hunt Adventures Game. Good Bye...."
                  ) +
                  chalk.bold.green("/////////////")
              );
            }
    ...
    console.log(
      chalk.bold.italic.yellow("Hey") +
        chalk.bold.italic.green(`${name.userName}`) +
        chalk.bold.italic.yellow(
          ", you went on difficult maze. You can't come out from here."
        )
    );
    console.log(
      chalk.bold.italic.green(`${name.userName}`) +
